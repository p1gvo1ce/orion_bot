...
async def update_megakostyl_channel(bot):
    ...
    while not bot.is_closed():
        ...
        embed.add_field(name="Суммарное время", value=f"{total_interval:.3f} секунд / {deletion_interval:.3f} | {creation_interval:.3f}", inline=False)
...
async def keep_api_alive(bot):
    ...
    while not bot.is_closed():
        ...
        await asyncio.sleep(30)  # Пингуем каждые 2 минуты