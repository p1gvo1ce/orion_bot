...
Нужно объяснить, что неосторожные названия вредят доступности сервера "Safe Space" во внешних источниках, сославшись на правила для сообществ Discord, а так же подчеркнуть свою досаду относительно этой цензуры.
---
