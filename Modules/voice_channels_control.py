...
Правила для нового названия: нужно сохранить смысл/мем/шутку, но сделать гипертрофированно детским, милым, наивным, розовым аналогом, будто название придумал пушистый розовый единорог.
...
Нужно объяснить, что неосторожные названия вредят доступности сервера во внешних источниках, сославшись на правила для сообществ Discord, а так же подчеркнуть свою досаду относительно этой цензуры.
---
